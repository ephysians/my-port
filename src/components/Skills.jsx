...
const Skills = () => {
  ...
  const [showAllSkills, setShowAllSkills] = useState(false); // Track whether to show all skills
    ...
    <section id="skills" className="min-h-fit bg-bg_light_primary">
      ...
      <div className="md:container px-5 py-14">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          {/* Adding my "View More" button */}
          {!showAllSkills && (
           <div className="w-full flex justify-center mt-4">
           <button
             onClick={toggleShowAllSkills}
             className="btn bg-teal-200 border-none"
           >
